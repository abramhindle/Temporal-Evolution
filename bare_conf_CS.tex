...
As proposed by Freeman, if a person locates
...
the other people in a network, the more important or central they are
\cite{BOOK:han}.
...
Compared to the approaches in other papers which produce results on
the entire time line chosen for the SNA, windowed analysis is to

...
organize and produce interesting collaboration structures (networks), furthermore these
structures might not be evident in a global analysis.
So in order to peer into these local self organized structures using
